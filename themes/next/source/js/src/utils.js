...
NexT.utils = NexT.$u = {
    ...
    $('.content img')
      ...
      .each(function() {
        ...
        if ($imageWrapLink.length < 1) {
          var imageLink = $image.attr('data-original')
  ...
  getContentVisibilityHeight: function() {
    ...
    var contentVisibilityHeight
      = docHeight > winHeight ? docHeight - winHeight : $doc.height() - winHeight;
